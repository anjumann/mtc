            ...
            <div className="relative flex items-center justify-between h-16">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                ...
                <Disclosure.Button className="inline-flex items-center justify-center p-2 rounded-md text-gray-900 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white mt-4">
                  ...
                  {open ? (<XIcon className="block h-6 w-6 text-center " aria-hidden="true" /> ): (
                    <MenuIcon className="block h-6 w-6 text-center " aria-hidden="true" />
                  )}
                </Disclosure.Button>
              </div>
                  ...
                  <div className="flex align-middle  space-x-4">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="text-gray-900 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-base font-semibold "
